  ...
  return (
    <div className="p-6 lg:px-8 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[hsl(212_35%_18%)] flex items-center justify-center shadow-md">
            <TrendingDown className="h-5 w-5 text-[hsl(210_55%_70%)]" />
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total a Pagar", value: fmtValor(totalPagar),    icon: DollarSign,    color: "text-red-500",    bg: "bg-red-50" },
          { label: "Pago no Mês",   value: fmtValor(totalPago),     icon: CheckCircle,   color: "text-green-600",  bg: "bg-green-50" },
          ...
          <div className="grid sm:grid-cols-4 gap-3 items-end">
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input className="pl-9 border-[hsl(210_30%_85%)]" placeholder="Descrição ou fornecedor..." value={busca} onChange={e => setBusca(e.target.value)} />
              </div>
            </div>
            <div>
              ...
              <TableBody>
                {filtered.length === 0 ? (
                  ...
                  <TableRow key={c.id} className={`${i % 2 === 0 ? "bg-card" : "bg-[hsl(210_30%_97%)]"} hover:bg-[hsl(210_40%_94%)] transition-colors border-b border-[hsl(210_30%_90%)]`}>
                    ...
                    <TableCell className="text-right font-semibold text-red-500">{fmtValor(c.valor)}</TableCell>
                    <TableCell>
