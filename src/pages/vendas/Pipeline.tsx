    ...
    <div className="w-full min-w-0 max-w-full space-y-4 overflow-x-hidden">
      ...
      {viewMode === "kanban" ? (
        <div className="relative w-full max-w-full min-w-0 overflow-hidden">
          <div className="flex w-full min-w-0 gap-3 overflow-x-auto overflow-y-hidden px-1 pb-5 scrollbar-thin" style={{ height: "calc(100vh - 280px)" }}>
            ...
            <div className="space-y-1.5">
              ...
              <Select value={form.tipoVeiculo} onValueChange={v => setForm({ ...form, tipoVeiculo: v })}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Vans e Pesados Pequenos">Vans e Pesados Pequenos</SelectItem>
